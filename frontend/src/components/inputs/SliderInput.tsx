...
function SliderInput(props: ComponentSetup) {
    ...
    return (
		<div className="mx-3 my-3">
            ...
            <input type="range" id="volume" name="volume" min={props.options?.[0]} max={props.options?.[1]} className="w-full bg-red" onChange={updateStateText} onLoad={updateStateText}/>
