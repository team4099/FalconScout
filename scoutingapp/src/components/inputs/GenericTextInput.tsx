...
function GenericTextInput(props: ComponentSetup) {
    ...
    return (
		...
		<div className="mx-3 my-3">
			...
			<input 
				className="appearance-none border border-color-[#D0D5DD] rounded w-full py-2 px-3  focus:outline-none" id="textInput" type="text" placeholder={props.placeholder?.[0]}
